...
function Header({ onContactClick }) {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full md:w-full justify-around pt-4 pb-4 mt-6 ">
        ...
        <div className="header-content w-full md:w-2/3 text-left space-y-4 flex flex-col justify-center ml-5 md:mr-8">
          ...
          <div className="header-button space-y-4 md:space-x-4 md:space-y-0 flex flex-col md:flex-row">
            <button
              ...
              className="bg-[#1e0d60] text-lg md:text-xl text-white px-4 py-2 md:px-6 md:py-3 rounded-full hover:bg-gray-700 transition duration-300 w-full md:w-auto"
            >
              Contact Me
            </button>
            <a href={resume} download className="w-full md:w-auto">
              <button className="bg-[#1e0d60] text-lg md:text-xl  text-white px-4 py-2 md:px-6 md:py-3 rounded-full hover:bg-gray-700 transition duration-300 w-full">
                Download Resume
              </button>
            </a>
          </div>
